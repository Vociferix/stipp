option(LINTS "Enable linters by default" ON)
...
if(CPPCHECK_LINTS)
    ...
    if(CPPCHECK)
        ...
        set(CPPCHECK_CMD
            ...
            # tests have conditionals that should always be true
            --suppress=knownConditionTrueFalse
            --suppress=duplicateExpression
            # this doesn't seem to jive with Catch2
